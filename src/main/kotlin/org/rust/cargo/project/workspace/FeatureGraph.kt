...
class FeatureGraph private constructor(
    ...
    fun apply(f: FeaturesView.() -> Unit): MutableMap<PackageFeature, FeatureState> =
    ...
    fun applyFlat(f: FeaturesView.() -> Unit): MutableMap<String, MutableMap<String, FeatureState>> =
    ...
    inner class FeaturesView {
        ...
        fun syncWith(userOverriddenFeatures: Map<PackageFeature, Boolean>) {
